            ...
            <SafeAreaView style={styles.container}>
                <View style={{ alignItems: "center" }}>
                    ...
                    <View style={styles.coverContainer}>
                        <Image source={require("./assets/traviswall.jpg")} style={styles.cover}></Image>
                    </View>

                    <View style={{ alignItems: "center", marginTop: 32 }}>
                        <Text style={[styles.textDark, { fontSize: 20, fontWeight: "500" }]}>HIGHEST IN THIS ROOM</Text>
                        <Text style={[styles.text, { fontSize: 16, marginTop: 8 }]}>Travis Scott</Text>
                    </View>
                </View>
